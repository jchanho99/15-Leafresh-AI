...
def generate_challenge_docs(file_path="challenge_docs.txt", mode="random", num_paragraphs=100):
    ...
    random_sentences = [
           ...
           "농촌에서 현장직으로 일하며 매일 퇴근 후 지역 농산물 직거래 장터에 참여하고 있습니다.",
        "산간 지역에서 재택근무하며 매주 자전거로 출퇴근하고 있습니다.",
        "바다 근처에서 플로깅을 실천하며 지역 해양 쓰레기 문제 해결에 기여하고 있습니다.",
        "도시에서 재택근무하며 매일 점심시간에 지역 카페에서 텀블러를 사용하고 있습니다.",
        "농촌에서 현장직으로 일하며 매주 자원봉사 활동을 통해 지역 사회에 기여하고 있습니다.",
        "도시에서 사무직으로 근무하며 코드 뽑기 캠페인을 통해 에너지를 절약하고 있습니다.",
        "도시에서 재택으로 근무하여 점심시간에 지역 농산물로 만든 비건 도시락을 먹고 있습니다.",
        "농촌에서 현장직으로 일하며 매일 퇴근 후 지역 농산물 직거래 장터에 참여하고 있습니다.",
        "도시 지역에서 사무직으로 근무하며 매일 퇴근 후 지역 카페에서 텀블러를 사용하고 있습니다.",
